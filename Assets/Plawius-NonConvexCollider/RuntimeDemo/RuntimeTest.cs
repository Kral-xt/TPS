...
namespace Plawius.NonConvexCollider.Editor.Test
{
    public class RuntimeTest : MonoBehaviour
    {
        public bool useNewCOACD = false;
        ...
        void Start()
        {
            ...
            {
                if (useNewCOACD)
                    meshes = API.GenerateConvexMeshesCoACD(mesh, CoACDParameters.Default());
                else
            ...
            using (var _ = new StopwatchScoped("NonConvexCollider generate add to gameobject"))
            {
                ...
                nonConvex.Algorithm = useNewCOACD ? DecompositionAlgorithm.CoACD_v2 : DecompositionAlgorithm.VHACD;
            }
        }
